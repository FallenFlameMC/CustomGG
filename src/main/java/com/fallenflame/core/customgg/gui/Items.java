...
public class Items {
    ...
    public static class Styles {
        public static ItemStack bars() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%s!%sBars%s!%s", ChatColor.MAGIC, ChatColor.RESET, ChatColor.MAGIC, ChatColor.RESET));
            stack.setItemMeta(stackMeta);
            return stack;
        }
        public static ItemStack bold() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%sBold", ChatColor.BOLD));
            stack.setItemMeta(stackMeta);
            return stack;
        }
        public static ItemStack underline() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%sUnderline", ChatColor.UNDERLINE));
            stack.setItemMeta(stackMeta);
            return stack;
        }
        public static ItemStack italic() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%sItalic", ChatColor.ITALIC));
            stack.setItemMeta(stackMeta);
            return stack;
        }
        public static ItemStack strike() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%sStrikethrough", ChatColor.STRIKETHROUGH));
            stack.setItemMeta(stackMeta);
            return stack;
        }
    }
    public static class Other {
        ...
        public static ItemStack preview() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%sPreview", ChatColor.BOLD));
            stack.setItemMeta(stackMeta);
            return stack;
        }
        public static ItemStack cancel() {
            ...
            ItemMeta stackMeta = stack.getItemMeta();
            stackMeta.setDisplayName(String.format("%s%sCancel", ChatColor.BOLD, ChatColor.RED));
            stack.setItemMeta(stackMeta);
            return stack;
        }
